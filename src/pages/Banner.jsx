...
const Banner = () => {
  return (
    <div className="bg-gray-50 relative max-w-7xl shadow-lg shadow-[#e9d9f3] mx-auto rounded overflow-hidden">
  <div className="grid md:grid-cols-2 max-md:gap-6">
    <div className="text-center p-6 flex flex-col justify-center items-center">
      <h2 className="font-extrabold text-5xl text-[#4e0083] leading-tight">
        <span className="text-slate-900">Special</span> Offer
      </h2>
      <h6 className="text-lg text-slate-900 mt-4">
        Discover amazing discounts, for limited time
      </h6>
      <button
        type="button"
        className="bg-[#4e0083] hover:bg-[#4f0083cc] text-white tracking-wide font-medium text-sm py-3 px-6 rounded-xl cursor-pointer mt-10"
      >
        Get Started
      </button>
      <ul className="flex flex-wrap justify-center gap-6 mt-8">
        <li className="flex items-center">
          ...
          <a href="javascript:void(0)" className="text-[#4e0083] text-sm ml-2">
            180-548-2588
          </a>
        </li>
        <li className="flex items-center">
